        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PersonalMessages_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TopicComments_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicCommentId = table.Column<int>(type: "int", nullable: true),
                    TopicId = table.Column<int>(type: "int", nullable: true),
                    PersonalMessageId = table.Column<int>(type: "int", nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interactions_PersonalMessages_PersonalMessageId",
                        column: x => x.PersonalMessageId,
                        principalTable: "PersonalMessages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interactions_TopicComments_TopicCommentId",
                        column: x => x.TopicCommentId,
                        principalTable: "TopicComments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interactions_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_PersonalMessageId",
                table: "Interactions",
                column: "PersonalMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_Interactions_TopicCommentId",
                table: "Interactions",
                column: "TopicCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Interactions_TopicId",
                table: "Interactions",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalMessages_ApplicationUserId",
                table: "PersonalMessages",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TopicComments_CreatorId",
                table: "TopicComments",
                column: "CreatorId");
